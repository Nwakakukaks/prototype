...
export async function getGrokAnalysis(
  ...
  try {
    ...
    await sendCharacterMessage(
      ...
      sessionId,
      docClient,
      "Okay, I'll check whats happening on X on crypto and Defi."
    );
          ...
          messages: [
            ...
            },
            {
              ...
              content: username
                ...
                : `How would we best position our Defi project in the current market landscape? Keep your response very concise and to the point in LESS THAN 50 words. Consider that we could launch ERC20 tokens, NFTs create tweets and so on. Return notable handles that are aligned to this goal.`,
            },
          ],
