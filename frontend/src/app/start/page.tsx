    ...
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-8">
          <Image
            src="https://jnoznbd6y3.ufs.sh/f/PKy8oE1GN2J3QmYJPJMB4oh9KpZbJwuajRl6c2XWTSfEVm85"
            alt="Prototype.ai Logo"
            width={700}
            height={300}
            ...
            <CardContent>
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  <ChevronRight className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Get support from Electronuem team to further successful
                    ideas
                  </span>
                </li>
              </ul>
